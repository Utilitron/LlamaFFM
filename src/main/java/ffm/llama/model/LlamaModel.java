...
public class LlamaModel implements AutoCloseable {
    ...
    public String getDescription() {
        ...
        try (Arena tempArena = Arena.ofConfined()) {
            ...
            if (len > 0) {
                return NativeMemoryUtils.readCStringExact(buffer, len);
            }
            return "Unknown";
        } catch (Throwable t) {
            return "Unknown";
    ...
    public String getChatTemplate() {
        ...
        try {
            ...
            return NativeMemoryUtils.readCString(templatePtr);
        } catch (Throwable t) {
    ...
    public String detokenize(int[] tokens, boolean special, boolean unparse) {
        ...
        try (Arena tempArena = Arena.ofConfined()) {
            ...
            return NativeMemoryUtils.readCStringExact(textBuf, len);
        } catch (Throwable t) {
